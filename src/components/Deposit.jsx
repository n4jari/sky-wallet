...
const Deposit = () => {
    ...
    const handleDeposit = async (e) => {
        ...
        if (price > 0) {
            try {
                ...
                toast(`واریز با موفقیت انجام شد`, { type: "success" })
                navigate('/')
            } catch (err) {
    ...
    return (
        <Form onSubmit={e => handleDeposit(e)} >
            ...
            <Typography variant="h6" align="center">واریز به حساب</Typography>
            <TextField
                type="number"
                size="small"
                fullWidth
            ...
            />
            <Button variant='contained' type='submit' disabled={!isDisable} sx={{ my: 2 }} fullWidth>واریز</Button>
        </Form>
    )
}
